...
- **MQL5 programs** (`mql5/`, 2026-09-26): `Experts/CandleSense.mq5` (candle-scoring EA with adaptive per-signal weights in terminal globals, ATR exits, risk gates) and `Scripts/SymbolScout.mq5` (ranks Market Watch symbols by ATR/spread room and trend efficiency). They're separate from the Python app. See `mql5/README.md`.
