...
A **strong H1 downtrend** (structure -2 or less), price below the 200 EMA, bounced over the 20 EMA and closed back below it with a down candle.

Questions are only asked between 10:00 and 20:00 server time (London open to late New York).

## Why pros take it
Selling bounces in a strong downtrend: a better price with the trend behind you.
...
- A late, stretched downtrend.
- A bounce that also broke the 50 EMA.
- The H1 structure is turning up.
...
## What the agent sees
`h1_structure`, `dist_ema20`, `dist_ema50`, `dist_ema200`, `body`. All 49 indicator inputs and the 178 chart inputs go in; these are the ones that matter most here.
