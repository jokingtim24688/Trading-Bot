...
Price is **more than 4 ATR above the session average** and just printed a strong down candle.

Questions are only asked between 10:00 and 20:00 server time (London open to late New York).

## Why pros take it
Stretched far above the day's average, price tends to fall back toward it; the strong candle is the first sign.
...
- A trend day or a news rally.
- One down candle inside a strong run.
- Counter-trend: more traps.
...
## What the agent sees
`sess_avg_dist`, `body`, `h1_structure`, `atr_rel`. All 49 indicator inputs and the 178 chart inputs go in; these are the ones that matter most here.
